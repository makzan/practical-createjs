namespace :book do
  ...
  task :build => :prebuild do
    ...
    # `mv practical-createjs.epub output/practical-createjs.epub`
  ...
  task :build_chapter_html => :prebuild do
    ...
    `bundle exec asciidoctor -a imagesdir=images -a stylesheet=web.css -a stylesdir=stylesheets -a linkcss -D output book/*/*.adoc`
